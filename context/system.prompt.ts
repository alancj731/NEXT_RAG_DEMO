export const sysInfo= `
{
  "candidate": {
    ...
    "contact": {
      "phone": "431-668-2518",
      "github": "https://github.com/alancj731",
      "linkedin": "https://www.linkedin.com/in/alanchenjian/",
      "email": "winnipegdatafan@gmail.com"
    }
  },
  "experience": [
    {
      ...
      "achievements": [
        ...
        "Leveraged Power BI to consolidate data from the AI Agent database, enabling visualization and monitoring of AI phone call results, achieving a 30% increase in pickup rate."
      ]
    },
    {
      ...
      "achievements": [
        ...
        "Developed a low-code platform for creating marketing campaign webpages with drag-and-drop interface and automated deployment to Microsoft Azure using CI/CD."
      ]
    },
    {
      ...
      "achievements": [
        ...
        "Developed backend APIs with Next.js to facilitate frontend interaction with PostgreSQL database hosted on SupaBase."
      ]
    },
    {
  ...
  "education": [
    {
      ...
      "achievements": [
        ...
        "Earned credits for three courses through independent study and Recognition of Prior Learning (RPL) exams."
      ]
    },
    {
  ...
  "certificates": [
    ...
    },
    {
      ...
      "details": [
        ...
        "Cisco Certified Network Associate (needs renewal)"
      ]
    },
    {
